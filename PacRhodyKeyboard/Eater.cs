...
namespace WindowsApplication22
{
	...
	public class Eater
	{
		...
		public Bitmap EaterImage = null;
		public Bitmap EaterImage2 = null;
		...
		public Eater()
		{
			...
			/*if (EaterImage  == null)
			{
				EaterImage = new Bitmap("pacman.gif");
			}
			
			if (EaterImage2  == null)
			{
				EaterImage2 = new Bitmap("pac-man-close-mouth.gif");
			}*/
		}
		...
		public Eater(int x, int y)
		{
			...
			if (EaterImage2  == null)
			{
				EaterImage2 = new Bitmap("pac-man-close-mouth-black.gif");
			}
		}
